...
- Name: a11y.spec.ts >> a11y audit (ar) >> settings (RTL) has no critical WCAG A/AA violations
...
- generic [active] [ref=f1e1]:
  - alert [ref=f1e2]
  - generic [ref=f1e4]:
    - generic [ref=f1e5]: اللغة
    - combobox "اللغة" [ref=f1e6] [cursor=pointer]:
      - option "English"
      - option "العربية" [selected]
  - generic [ref=f1e7]:
    - complementary [ref=f1e8]:
      - link "عقاري" [ref=f1e10] [cursor=pointer]:
        - /url: /ar
      - navigation "القائمة" [ref=f1e17]:
        - link "لوحة التحكم" [ref=f1e18] [cursor=pointer]:
          - /url: /ar
        - link "العقارات العامة" [ref=f1e23] [cursor=pointer]:
          - /url: /ar/properties
        - link "المفضلة" [ref=f1e28] [cursor=pointer]:
          - /url: /ar/favorites
        - link "عمليات البحث المحفوظة" [ref=f1e32] [cursor=pointer]:
          - /url: /ar/saved-searches
        - link "الإشعارات" [ref=f1e36] [cursor=pointer]:
          - /url: /ar/notifications
        - link "التقييمات" [ref=f1e41] [cursor=pointer]:
          - /url: /ar/reviews
        - link "زياراتي" [ref=f1e45] [cursor=pointer]:
          - /url: /ar/dashboard/viewings
        - link "المحادثات" [ref=f1e50] [cursor=pointer]:
          - /url: /ar/chat
        - link "الإعدادات" [ref=f1e54] [cursor=pointer]:
          - /url: /ar/settings
      - generic [ref=f1e60]:
        - paragraph [ref=f1e65]: هل تحتاج مساعدة؟
        - paragraph [ref=f1e66]: راجع وثائقنا للمزيد من المعلومات.
        - button "عرض الوثائق" [ref=f1e67] [cursor=pointer]
    - generic [ref=f1e68]:
      - banner [ref=f1e69]:
        - heading "إعدادات الحساب" [level=1] [ref=f1e70]
        - generic [ref=f1e71]:
          - button "بحث" [ref=f1e72] [cursor=pointer]
          - switch "Toggle theme" [ref=f1e83] [cursor=pointer]
          - button "الإشعارات" [ref=f1e86] [cursor=pointer]
          - link [ref=f1e91] [cursor=pointer]:
            - /url: /ar/login
            - button "تسجيل الدخول" [ref=f1e92]
      - main [ref=f1e93]:
        - generic [ref=f1e94]:
          - generic [ref=f1e95]:
            - heading "إعدادات الحساب" [level=1] [ref=f1e96]
            - paragraph [ref=f1e97]: أدر هويتك، ملفك الشخصي كمنشئ، كلمة المرور، والأمان.
          - generic [ref=f1e98]:
            - complementary [ref=f1e99]:
              - navigation "أقسام الإعدادات" [ref=f1e100]:
                - link "الملف الشخصي" [ref=f1e101] [cursor=pointer]:
                  - /url: /ar/settings/profile
                - link "الأمان" [ref=f1e105] [cursor=pointer]:
                  - /url: /ar/settings/security
                - link "الإشعارات" [ref=f1e108] [cursor=pointer]:
                  - /url: /ar/settings/notifications
                - link "الحساب" [ref=f1e112] [cursor=pointer]:
                  - /url: /ar/settings/account
            - paragraph [ref=f1e117]: جاري تحميل الحساب...
