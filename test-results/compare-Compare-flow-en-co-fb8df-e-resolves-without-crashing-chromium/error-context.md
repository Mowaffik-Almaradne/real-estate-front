...
- Name: compare.spec.ts >> Compare flow (en) >> /compare page resolves without crashing
...
- combobox "Language":
  ...
  - option "العربية"
- banner:
  - heading "Compare properties" [level=1]
  - paragraph: Add up to 4 properties to compare them side-by-side.
- heading "Nothing to compare yet" [level=2]
- paragraph: Browse properties and tap the Compare button on any card to add it here.
