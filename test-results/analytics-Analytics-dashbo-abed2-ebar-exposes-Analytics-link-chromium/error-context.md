...
- Name: analytics.spec.ts >> Analytics dashboard (ar) >> sidebar exposes Analytics link
...
Locator: getByRole('link', { name: /التحليلات/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /التحليلات/ }).first()
...
- banner:
  ...
  - link "تسجيل الدخول":
    ...
    - button "تسجيل الدخول"
- main:
  - heading "لوحة عقارية !" [level=2]
  - paragraph: إليك نظرة عامة على أعمالك العقارية.
  - text: +12.5%
  - paragraph: "248"
