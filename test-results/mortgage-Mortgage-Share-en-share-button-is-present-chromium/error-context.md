...
- Name: mortgage.spec.ts >> Mortgage + Share (en) >> share button is present
- Location: e2e/mortgage.spec.ts:19:9
...
Locator: getByRole('button', { name: /share|مشاركة/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /share|مشاركة/i }).first()
