...
export function ConnectionStatus({ isConnected }: ConnectionStatusProps) {
  ...
  if (isConnected) {
    return (
      <span role="status" className="inline-flex items-center gap-1.5 text-emerald-600">
  ...
  return (
    <span role="status" className="inline-flex items-center gap-1.5 text-amber-600">
