...
const enLabels: LocaleLabels = {
  ...
  "rentalCards.fields.propertySearchPlaceholder": "Search properties…",
  "rentalCards.errors.noPropertiesFound": "No properties found.",
  "rentalCards.errors.propertyLoadFailed": "Could not load properties.",
  "rentalCards.errors.propertyRequired": "Property is required.",
...
const arLabels: LocaleLabels = {
  ...
  "rentalCards.fields.propertySearchPlaceholder": "ابحث عن عقار…",
  "rentalCards.errors.noPropertiesFound": "لا توجد عقارات.",
  "rentalCards.errors.propertyLoadFailed": "تعذر تحميل العقارات.",
  "rentalCards.errors.propertyRequired": "العقار مطلوب.",
